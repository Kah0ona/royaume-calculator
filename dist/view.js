...
(function( app, $, undefined ) {
   ...
   /** Show the div with id screenId, and hide all other divs that have the
	...
	app.view.renderRoomSelectionScreen = function(data){
		...
		html += "<p>Voeg hieronder ruimtes toe, en klik daarna op 'Toevoegen'. U kunt zoveel ruimtes toevoegen als u wilt. Als u al uw ruimtes hebt ingesteld, klikt u op 'Volgende'</p>";   
	...
	function getAgendaHTML(agenda) {
		var html = "Klik op de tijdstippen wanneer u wilt dat wij komen schoonmaken. U kunt meerdere momenten aangeven. U kunt een tijdstip weer uitzetten door er nogmaals op te klikken. Klik daarna op 'Volgende'";
	...
	function getNewFormHTML(rooms){
		...
		html += "<td><a href='#' id='add-room' class='add-room-button'>Toevoegen</a></td>";
		html+="</tr>";	
